...
const rollingDice = function () {
  if (!gameEnd) {
    ...
    currentPlayer[1].textContent =
      Number(currentPlayer[1].textContent) + number;
    if (number === 1) {
...
const holdScore = function () {
  if (!gameEnd) {
    currentPlayer[0].textContent =
      Number(currentPlayer[0].textContent) +
      Number(currentPlayer[1].textContent);
    currentPlayer[1].textContent = 0;
    // Winner
    if (Number(currentPlayer[0].textContent) >= 10) {
